...
const cookieTableName = "cookie-data-table";
const cookieId = 1;
...
const useragent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3618.0 Safari/537.36';
...
const homepage = 'http://facebook.com';

//what is our account name? used to verify login
const accountName = 'gamesbykevin';

//how long to wait for a page to load
const timeoutload = 30000;
...
const tags = '#gamedev #indiedev #game #games #android #gaming #gameart #androidapps #gamesbykevin';

//we want to post the latest video post on youtube
const youtubeRssFeed = 'https://www.youtube.com/feeds/videos.xml?channel_id=UCzAR2PtHsFdif7W5orovMyA';
